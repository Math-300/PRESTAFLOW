   ...
   return (
      <div className="fixed inset-0 z-[60] flex items-end md:items-center justify-center bg-black/60 backdrop-blur-sm p-0 md:p-4 transition-opacity duration-300">
         <form
            ...
            className="bg-white rounded-t-[32px] md:rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden h-[92vh] md:h-auto md:max-h-[95vh] flex flex-col animate-in slide-in-from-bottom duration-300 md:animate-none"
         ...
         >
            ...
            {/* HEADER */}
            <div className="bg-slate-900 pt-2 md:pt-4 px-5 pb-3 flex justify-between items-center text-white shrink-0">
               ...
               <div className="flex items-center gap-2">
                  <span className="text-[10px] bg-slate-800 px-2 py-1 rounded border border-slate-700 font-mono hidden sm:inline-block uppercase tracking-tighter">ESC</span>
                  <button
                     type="button"
                     onClick={onClose}
