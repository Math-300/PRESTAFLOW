...
import { Users, UserPlus, Shield, Trash2, Mail, CheckCircle, AlertTriangle, Loader2, X, Clock, Copy, Link as LinkIcon } from 'lucide-react';
...
export const UserManagement: React.FC = () => {
  ...
  const handleRoleChange = async (memberId: string, newRole: string) => {
      await updateMemberRole(memberId, newRole as UserRole);
  };
               ...
               <>
                 {isDataLoading ? (
                    ...
                    members.map(member => {
                        ...
                        return (
                            <div key={member.id} className="p-4 flex items-center justify-between hover:bg-slate-50 transition-colors animate-in fade-in">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="font-bold text-slate-800 text-sm flex items-center gap-2">
                                            {member.profile?.email || 'Usuario Desconocido'}
