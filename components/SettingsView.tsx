...
export const SettingsView: React.FC<SettingsViewProps> = ({
   ...
   return (
      <div className="max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500 overflow-y-auto h-full pr-2">
         <div className="mb-6 flex justify-between items-center">
            <div>
               <h2 className="text-3xl font-bold text-slate-800">Configuración</h2>
               <p className="text-slate-500">Personaliza la experiencia de {settings.companyName}</p>
            </div>
         </div>
         ...
         <div className="space-y-6 pb-12">
            ...
            {/* GENERAL TAB */}
            {activeTab === 'GENERAL' && (
               <div className="space-y-6 animate-in fade-in slide-in-from-right-4 max-w-4xl">
