...
-- NOTA: bank_accounts.id es TEXT en este proyecto (no uuid).
create or replace function public.bump_bank_balance(p_bank_id text, p_delta numeric, p_allow_negative boolean default false)
